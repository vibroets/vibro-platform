...
export default function AdminDashboardPage() {
  const { isFullAccess, isSuperAdmin } = useModuleAccess("learning_training");
                      ...
                      <div key={cert.id} className={`bg-gradient-to-br rounded-lg shadow-md overflow-hidden ${isExpired ? "from-gray-100 to-gray-200" : "from-yellow-50 to-amber-100 border-2 border-yellow-400"}`}>
                        <div className="p-5">
                          ...
                          <div className="flex gap-2">
                            ...
                            {canEdit && <button onClick={() => handleShareCertificate(cert)} className="flex-1 flex items-center justify-center px-3 py-2 bg-green-600 text-white rounded-lg text-sm font-semibold hover:bg-green-700 transition"><Share2 className="w-4 h-4 mr-1" /> Share</button>}
                          </div>
                        </div>
                      </div>
                    );
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[92vh] overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              ...
              <div className="flex items-center gap-2">
                ...
                {canEdit && <button onClick={() => handleShareCertificate(selectedCertificate)} className="p-2 text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition" title="Share">
